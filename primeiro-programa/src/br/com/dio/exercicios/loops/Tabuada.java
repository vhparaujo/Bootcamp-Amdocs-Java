...
public class Tabuada {
	...
	public static void main(String[] args) {
		...
		System.out.println("Digite o número que deseja obter a tabuada: "); //frase ilustrativa para indicar a tabuada
		int tabuada = scan.nextInt(); 
		
		System.out.println("Tabuada do: " + tabuada); //frase ilustrativa para indicar a tabuada
